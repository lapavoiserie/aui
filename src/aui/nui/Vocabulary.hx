...
class Vocabulary {
	...
	public static function registerWithMui():Void {
		mui.macros.Backend.register({
			...
			honoured: () -> [
				nui.Modifiers.PADDING, nui.Modifiers.BACKGROUND_COLOR,
				nui.Modifiers.FOREGROUND_COLOR, nui.Modifiers.OPACITY,
				nui.Modifiers.CLIP, nui.Modifiers.WIDTH, nui.Modifiers.HEIGHT,
			],
			#end
		});
	}
